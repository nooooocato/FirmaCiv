...
angledWaterCraftFrame = {
    "facing=north,shape=straight": {
        "model": "firmaciv:block/watercraft_frame/angled/straight",
        "y": 180
    },
    ...
    "facing=north,shape=inner_left": {
        "model": "firmaciv:block/watercraft_frame/angled/inner",
        "y": 90
    },
    ...
    "facing=north,shape=outer_left": {
        "model": "firmaciv:block/watercraft_frame/angled/outer",
        "y": 270
    },
...
def getWoodFrameMultipart(wood: str) -> list[Json]:
    ...
    json = [
        ({"facing": "north", "shape": "straight"},
         {"model": "firmaciv:block/watercraft_frame/angled/straight", "y": 180}),
        ({"facing": "east", "shape": "straight"},
         {"model": "firmaciv:block/watercraft_frame/angled/straight", "y": 270}),
        ({"facing": "south", "shape": "straight"},
         {"model": "firmaciv:block/watercraft_frame/angled/straight"}),
        ({"facing": "west", "shape": "straight"},
         {"model": "firmaciv:block/watercraft_frame/angled/straight", "y": 90}),
        ({"facing": "north", "shape": "inner_left"},
         {"model": "firmaciv:block/watercraft_frame/angled/inner", "y": 90}),
        ({"facing": "east", "shape": "inner_left"},
         {"model": "firmaciv:block/watercraft_frame/angled/inner", "y": 180}),
        ({"facing": "south", "shape": "inner_left"},
         {"model": "firmaciv:block/watercraft_frame/angled/inner", "y": 270}),
        ({"facing": "west", "shape": "inner_left"},
         {"model": "firmaciv:block/watercraft_frame/angled/inner"}),
        ({"facing": "north", "shape": "outer_left"},
         {"model": "firmaciv:block/watercraft_frame/angled/outer", "y": 270}),
        ({"facing": "east", "shape": "outer_left"},
         {"model": "firmaciv:block/watercraft_frame/angled/outer"}),
        ({"facing": "south", "shape": "outer_left"},
         {"model": "firmaciv:block/watercraft_frame/angled/outer", "y": 90}),
        ({"facing": "west", "shape": "outer_left"},
         {"model": "firmaciv:block/watercraft_frame/angled/outer", "y": 180}),
        ({"facing": "north", "shape": "inner_right"},
         {"model": "firmaciv:block/watercraft_frame/angled/inner", "y": 180}),
        ({"facing": "east", "shape": "inner_right"},
         {"model": "firmaciv:block/watercraft_frame/angled/inner", "y": 270}),
    ...
    for template, processedStates in plankTemplateStates.items():
        ...
        json += [
            ({"facing": "north", "shape": "straight", "frame_processed": processedStates},
             {"model": f"firmaciv:block/wood/watercraft_frame/angled/{wood}/straight/{template}",
              "uvlock": True,
              "y": 180}),
            ...
            for template, processedStates in plankTemplateStates.items():
                json += [
                    ({"facing": "north", "shape": f"{shape}_{side}", "frame_processed": processedStates},
                     {"model": f"firmaciv:block/wood/watercraft_frame/angled/{wood}/{shape}/{template}",
                      "uvlock": True,
                      "y": rotation[0]}),
    ...
    for template, processedStates in boltTemplateStates.items():
        ...
        json += [
            ({"facing": "north", "shape": "straight", "frame_processed": processedStates},
             {"model": f"firmaciv:block/watercraft_frame/angled/bolt/straight/{template}",
              "uvlock": True,
              "y": 180}),
            ({"facing": "east", "shape": "straight", "frame_processed": processedStates},
             {"model": f"firmaciv:block/watercraft_frame/angled/bolt/straight/{template}",
    ...
    for shape, rotations in {"inner": inner, "outer": outer}.items():
        for side, rotation in rotations.items():
            for template, processedStates in boltTemplateStates.items():
                json += [
                    ({"facing": "north", "shape": f"{shape}_{side}", "frame_processed": processedStates},
                     {"model": f"firmaciv:block/watercraft_frame/angled/bolt/{shape}/{template}",
                      "uvlock": True,
                      "y": rotation[0]}),
                    ({"facing": "east", "shape": f"{shape}_{side}", "frame_processed": processedStates},
                     {"model": f"firmaciv:block/watercraft_frame/angled/bolt/{shape}/{template}",
